                    ...
                    <div id="skills" v-for="skill in displaySkills()" :key="skill.id">
                        ...
                        <div class="row justify-content-center mx-3 py-3">
                            <div class="col-lg-5 col-col-md-4 col-sm-12 pb-2 align-content-center">
                                ...
                                <div class="row">
                                    <div class="codeSkills mt-2" data-aos="fade-up">
                                        <div>
                            ...
                            <div class="col-lg-5 col-col-md-4 col-sm-12 pb-2 align-content-center">
                                ...
                                <div class="row">
                                    ...
                                    <div class="softSkills mt-2" data-aos="fade-up">
                                        <div>
                                            <i :class="skill.softSkills[4].iconClass"></i>
                                        </div>
                                        <div>
                                            {{ skill.softSkills[4].softSkill }}
                                        </div>
                                        <div>
                                            {{ skill.softSkills[4].description }}
                                        </div>
                                    </div>
                                    <div class="softSkills mt-2" data-aos="fade-up">
                                        <div>
                                            <i :class="skill.softSkills[5].iconClass"></i>
                                        </div>
                                        <div>
                                            {{ skill.softSkills[5].softSkill }}
                                        </div>
                                        <div>
                                            {{ skill.softSkills[5].description }}
                                        </div>
                                    </div>
                                    <div class="softSkills mt-2" data-aos="fade-up">
                                        <div>
                                            <i :class="skill.softSkills[6].iconClass"></i>
                                        </div>
                                        <div>
                                            {{ skill.softSkills[6].softSkill }}
                                        </div>
                                        <div>
                                            {{ skill.softSkills[6].description }}
                                        </div>
                                    </div>
                                    <div class="softSkills mt-2" data-aos="fade-up">
                                        <div>
                                            <i :class="skill.softSkills[7].iconClass"></i>
                                        </div>
                                        <div>
                                            {{ skill.softSkills[7].softSkill }}
                                        </div>
                                        <div>
                                            {{ skill.softSkills[7].description }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mt-2" v-for="project in displayProjects()" :key="project.id">
                                <div class="card mt-3 col-lg-4 col-md-4 col-sm-12 mx-2" data-aos="fade-up">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a :href="project.live" target="blank" class="btn">Live</a>
                                    </div>
                                </div>
                            </div>
                        </div>
